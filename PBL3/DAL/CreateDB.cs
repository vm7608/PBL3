    ...
    //DropCreateDatabaseAlways<MyData>
    {
        protected override void Seed(MyData context)
        {
            ...
            context.Universities.AddRange(new University[]
            {
                ...
                new University {UniversityID = 1, UniversityName = "ĐH Bách Khoa Đà Nẵng", WardID = 43},
                new University {UniversityID = 2, UniversityName = "ĐH CNTT & TT Việt Hàn", WardID = 46},
                new University {UniversityID = 3, UniversityName = "ĐH Kinh Tế Đà Nẵng", WardID = 49},
                new University {UniversityID = 4, UniversityName = "ĐH Kỹ thuật Y dược Đà Nẵng", WardID = 14},
                new University {UniversityID = 5, UniversityName = "ĐH Ngoại Ngữ Đà Nẵng", WardID = 30},
                new University {UniversityID = 6, UniversityName = "ĐH Sư Phạm Đà Nẵng", WardID = 44},
                new University {UniversityID = 7, UniversityName = "ĐH Sư Phạm Kỹ thuật Đà Nẵng", WardID = 23},
                new University {UniversityID = 8, UniversityName = "ĐH Thể dục Thể thao Đà Nẵng", WardID = 38},
                new University {UniversityID = 9, UniversityName = "Khoa CNTT & TT ĐH Đà Nẵng", WardID = 46},
                new University {UniversityID = 10, UniversityName = "Khoa Y dược - ĐH Đà Nẵng", WardID = 47},
                new University {UniversityID = 11, UniversityName = "ĐH Duy Tân", WardID = 36},
                new University {UniversityID = 12, UniversityName = "ĐH Đông Á", WardID = 17},
                new University {UniversityID = 13, UniversityName = "ĐH Kiến Trúc Đà Nẵng", WardID = 17},
            });
            ...
            {
                new Rating {RatingID = 1, PostID = 1, UserID = 2, Star = 5},
                new Rating {RatingID = 2, PostID = 2, UserID = 2, Star = 5},
                new Rating {RatingID = 3, PostID = 7, UserID = 3, Star = 5},
                new Rating {RatingID = 4, PostID = 8, UserID = 3, Star = 5},
            });
        }
    }
}
