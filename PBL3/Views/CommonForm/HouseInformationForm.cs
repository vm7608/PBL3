...
namespace PBL3.Views.CommonForm
{
    public partial class HouseInformationForm : Form
    {
        ...
        {
            int stars = RatingBLL.Instance.GetStars(LoginInfo.UserID, PostID);
            switch (stars)
            {
                case 1:
                    Display1Star();
        ...
        {
            //PostViewDTO post = PostBLL.Instance.GetPostByID(PostID);
            //string contact = UserBLL.Instance.GetContactInformation(LoginInfo.UserID);
            //string name = UserBLL.Instance.GetNameInformation(LoginInfo.UserID);
        ...
        private void ConfirmRating()
        {
            ...
            {
                RatingBLL.Instance.AddRating(LoginInfo.UserID, PostID, starNum);
        ...
        private void uploadCmtBtn_Click(object sender, EventArgs e)
        {
            if (cmtTextbox.Text != "")
            {
                CommentBLL.Instance.AddComment(LoginInfo.UserID, PostID, cmtTextbox.Text);
                cmtTextbox.Text = "";
            }
            else
