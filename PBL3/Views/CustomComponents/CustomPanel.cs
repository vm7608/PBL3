...
namespace PBL3.Views.CustomComponents
{
    public class CustomPanel : Panel
    {
        ...
        public float GradientAngle { get => gradientAngle;
            set
            {
                gradientAngle = value;
                this.Invalidate();
        ...
        public Color GradientTopColor { get => gradientTopColor;
            set
            {
        ...
        public Color GradientBottonColor { get => gradientBottonColor;
            set
            {
